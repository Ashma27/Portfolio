...
<!-- Mirrored from Ashma-html.netlify.app/index3 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 05 Mar 2024 19:12:57 GMT -->
...
<head>
  ...
  <!-- Favicon Icon -->
  <link rel="icon" href="<?php echo get_parent_theme_file_uri(
      '/assets/img/aplogo.png'
  ); ?>" />
  <!-- Stylesheets -->
  <link rel="stylesheet" href="<?php echo get_parent_theme_file_uri(
...
<body id="home">
      ...
      <div class="container">
        <div class="st-main-header-in">
          <div class="st-main-header-left">
            <a class='st-site-branding' style="    font-size: 15px;
    color: #fdfeff;
    font-family: 'Roboto', sans-serif;
    font-weight: 500;" href='index.html'><img src="<?php echo get_parent_theme_file_uri(
        '/assets/img/aplogo.png'
    ); ?>" style="    max-width: 62px;
    border-radius: 50%;" alt="Ashma">Ashma Parveen</a>
          </div>
          <div class="st-main-header-right">
            <div class="st-nav">
              ...
              <div class="sp-phone">
                ...
                <div class="sp-phone-no">+91 9582920203</div>
              </div>
            </div>
          </div>
        </div>
  ...
  <!-- Start Hero Seciton -->
  <section class="st-hero st-style2 st-bg st-dynamic-bg st-ripple-version" data-src="<?php echo get_parent_theme_file_uri(
      '/assets/img/hero-bg-1.jpg'
  ); ?>">
    <div class="container">
      <div class="st-hero-text">
        <div class="st-author"><img src="<?php echo get_parent_theme_file_uri(
            '/assets/img/section/hero-img.jpg'
        ); ?>"></div>
        <h1>Hi, I am <span>Ashma Parveen</span></h1>
        ...
        <div class="st-hero-social-links">
          ...
          <a href="https://www.linkedin.com/in/ashma-parveen-45ba82163/" target="_blank" class="st-social-btn">
                  <i class="fab fa-linkedin"></i>
                </a>
          <!-- <a href="https://ashma27.github.io/Portfolio/" target="_blank" class="st-social-btn">
      ...
      <div class="row">
        <!-- <div class="col-lg-6 wow fadeInLeft">
          <div class="st-about-img-wrap">
            <div class="st-about-img st-dynamic-bg st-bg" data-src="<?php echo get_parent_theme_file_uri(
                '/assets/img/section/about.jpg'
            ); ?>"></div>
          </div>
          <div class="st-height-b0 st-height-lg-b30"></div>
        </div> -->
        <div class="col-lg-12">
          <div class="st-vertical-middle text-center">
            <div class="st-vertical-middle-in">
              <div class="st-text-block st-style1">
                <h2 class="st-text-block-title">Hi There! I'm Ashma Parveen</h2>
                <h4 class="st-text-block-subtitle">Frontend Developer</h4>
                <div class="st-text-block-text">
                  <p>I am a Frontend Developer with a strong focus on Web applications.
                     Visul design seeks to attract,
                ...
                <!-- <ul class="st-text-block-details st-mp0">
                  <li><span>Birthday</span> : <span>Feb 01, 1990</span></li>
                  <li><span>Phone</span> : <span>+919582920203</span></li>
                  <li><span>Email</span> : <span>ashmaparveen27@gmail.com</span></li>
                  <li><span>From</span> : <span>Uttar Pardesh India</span></li>
                  <li><span>Language</span> : <span>Hindi, English</span></li>
        ...
        <!-- <div class="col-lg-6">
          <div class="st-resume-wrap">
            <div class="st-resume-heading">
              <img src="
              //echo get_parent_theme_file_uri(
                  // '/assets/img/icon/resume-icon1.png'
              ); ?>" alt="resume-icon">
          ...
          <div class="st-resume-wrap">
            <div class="st-resume-heading">
              <img src="<?php echo get_parent_theme_file_uri(
                  '/assets/img/icon/resume-icon2.png'
              ); ?>" alt="resume-icon">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="st-portfolio-single st-style1 st-lightgallery">
            <div class="st-portfolio-item">
              <a href="https://designoweb.com/" target="_blank" class="st-portfolio">
                <div class="st-portfolio-img st-zoom-in">
                  <img src="<?php echo get_parent_theme_file_uri(
                      '/assets/img/portfolio/dw.png'
                  ); ?>" alt="portfolio">
                </div>
            ...
            <div class="slick-slide-in">
              <div class="st-testimonial st-style1 wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.2s">
                <div class="st-testimonial-text">
                  ...
                  <div class="st-quote"><img src="<?php echo get_parent_theme_file_uri(
                      '/assets/img/icon/quote.png'
                  ); ?>" alt="quote"></div>
                </div>
                <div class="st-testimonial-info">
                  <div class="st-testimonial-img"><img src="<?php echo get_parent_theme_file_uri(
                      '/assets/img/client/client1.png'
                  ); ?>" alt="client1"></div>
          ...
          <div class="slick-wrapper">
            <div class="slick-slide-in">
              <div class="st-post-single st-style1">
                <a class='st-post-thumb st-zoom' href='blog-details.html'>
                  <img src="<?php echo get_parent_theme_file_uri(
                      '/assets/img/blog/blog1.jpg'
                  ); ?>" class="st-zoom-in" alt="blog1">
                </a>
          ...
          <div class="st-contact-info-wrap">
            <div class="st-single-contact-info">
              ...
              <div class="st-single-info-details">
                <h4>Email</h4>
                <a href="#">ashmaparveen27@gmail.com</a>
              </div>
            </div>
            <div class="st-single-contact-info">
            ...
            <div class="st-single-contact-info">
              ...
              <div class="st-single-info-details">
                <h4>Address</h4>
                <span>Kanpur, <br>Uttar Pardesh India</span>
              </div>
            </div>
  ...
  <footer>
    <div class="container">
      <div class="st-copyright-wrap text-center">
        <div class="st-copyright-text"> Designed by Ashma Parveen.</div>
      </div>
    </div>
  </footer>
  <!-- End Footer Seciton -->
  ...
  <!-- Scripts -->
  <script src="<?php echo get_parent_theme_file_uri(
      '/assets/js/jquery-1.12.4.min.js'
  ); ?>"></script>
  <script src="<?php echo get_parent_theme_file_uri(
      '/assets/js/jquery.slick.min.js'
  ); ?>"></script>
  <script src="<?php echo get_parent_theme_file_uri(
...
<!-- Mirrored from Ashma-html.netlify.app/index3 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 05 Mar 2024 19:13:24 GMT -->
</html>