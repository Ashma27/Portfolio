...
if ( class_exists("Kirki")){
	...
	Kirki::add_field( 'theme_config_id', [
		...
		'label'       => esc_html__( 'Adjust Logo Size', 'web-agency-elementor' ),
	...
	Kirki::add_section( 'web_agency_elementor_additional_setting', array(
	    ...
	    'description'    => esc_html__( 'Additional Settings of themes', 'web-agency-elementor' ),
