...
function web_agency_elementor_logo_resizer() {
    ...
    $web_agency_elementor_logo_resizer = get_theme_mod('web_agency_elementor_logo_resizer');

	$web_agency_elementor_theme_logo_size_css = '
		.custom-logo{
			height: '.esc_attr($web_agency_elementor_logo_resizer).'px !important;
			width: '.esc_attr($web_agency_elementor_logo_resizer).'px !important;
		}
	';
...
define('WEB_AGENCY_ELEMENTOR_FREE_THEME_DOC',__('https://www.wpelemento.com/theme-documentation/web-agency-elementor/','web-agency-elementor'));
...
define('WEB_AGENCY_ELEMENTOR_BUY_NOW',__('https://www.wpelemento.com/elementor/web-design-agency-wordpress-theme/','web-agency-elementor'));
define('WEB_AGENCY_ELEMENTOR_LIVE_DEMO',__('https://www.wpelemento.com/demo/web-agency-elementor/','web-agency-elementor'));
define('WEB_AGENCY_ELEMENTOR_THEME_BUNDLE',__('https://www.wpelemento.com/elementor/wordpress-theme-bundle/','web-agency-elementor'));
