...
<header id="site-navigation" class="header text-center text-md-left py-2 <?php if( get_theme_mod( 'web_agency_elementor_sticky_header',false) != '') { ?>sticky-header<?php } else { ?>close-sticky <?php } ?>">
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-2 col-md-2 col-sm-3  align-self-center head-btn text-center text-md-right">
